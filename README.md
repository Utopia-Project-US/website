...
- Revised both Official Constitutional Lexicon orientations: restored the approved earlier seal, contained it completely within the title panel, reclaimed footer space for cleaner separation, and carried the expanded institutions treatment into the portrait layout.
